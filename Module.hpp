...
namespace Apostol {
    ...
    namespace Module {
        ...
        public:
            ...
            CQueueHandler(CQueueModule *AModule, COnQueueHandlerEvent && Handler);
            ...
            CQueueModule *Module() const { return m_pModule; };
        ...
        class CQueueModule: public CApostolModule {
        protected:
        ...
        public:
            ...
            CQueueModule(size_t AMaxQueue, CModuleProcess *AProcess, const CString& ModuleName, const CString& SectionName);

            ~CQueueModule() override = default;
